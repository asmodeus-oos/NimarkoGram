...
public final class NebulaMessageMenuInjector {
    ...
    private NebulaMessageMenuInjector() {}
    ...
    public static void injectCreateQuote(
        ...
        if (!app.nebulagram.messenger.quotes.NebulaQuoteCreator.canCreate(chatActivity, selectedObject, selectedObjectGroup)) return;
    ...
    public static void injectClearFromCache(
        ...
        if (!NebulaConfig.showClearFromCache) return;
    ...
    public static void injectForwardWoAuthorship(
        ...
        if (!NebulaConfig.showForwardWoAuthorship) return;
    ...
    public static void injectViewHistory(
        ...
        if (!NebulaConfig.showViewHistory) return;
    ...
    public static void injectSaveMessage(
        ...
        if (!NebulaConfig.showSaveMessage) return;
        if (noforwardsOrPaidMedia) return;
    ...
    public static void injectJSON(
        ...
        if (NebulaConfig.showJSON && !NebulaConfig.showDetails) {
            items.add("JSON");
            options.add(app.nebulagram.messenger.utils.chats.NebulaChatActivityHelper.OPTION_DETAILS);
    ...
    public static void injectForwardWoCaption(
        ...
        if (!NebulaConfig.showForwardWoCaption) return;
        if (selectedObject == null) return;
        if (noforwardsOrPaidMedia) return;
        if (selectedObject.isSponsored()) return;
        if (chatMode == ChatActivity.MODE_QUICK_REPLIES || chatMode == ChatActivity.MODE_SCHEDULED) return;
        ...
        options.add(app.nebulagram.messenger.utils.chats.NebulaChatActivityHelper.OPTION_FORWARD_WO_CAPTION);
        icons.add(R.drawable.msg_forward);
    }
    ...
    public static void injectDownloadSticker(
        ...
        if (!NebulaConfig.showDownloadSticker) return;
        if (selectedObject == null) return;
        if (selectedObject.isAnimatedSticker()) return;

        items.add(LocaleController.getString(R.string.NM_MI_DownloadSticker));
        options.add(app.nebulagram.messenger.utils.chats.NebulaChatActivityHelper.OPTION_DOWNLOAD_STICKER);
    ...
    public static void injectGetCustomReactions(
        ...
        if (!NebulaConfig.showGetCustomReactions) return;
        if (selectedObject == null) return;
        ...
        options.add(app.nebulagram.messenger.utils.chats.NebulaChatActivityHelper.OPTION_GET_CUSTOM_REACTIONS);
        icons.add(R.drawable.msg_emoji_smiles);
    }

    public static void injectNebulaMediaDownload(
        MessageObject selectedObject,
        ArrayList<CharSequence> items,
        ArrayList<Integer> options,
        ArrayList<Integer> icons
        ...
        if (!app.nebulagram.messenger.media.NebulaMediaDownloader.messageHasSupportedUrl(text)) return;

        items.add(LocaleController.getString(R.string.NM_DownloadMedia));
        options.add(app.nebulagram.messenger.utils.chats.NebulaChatActivityHelper.OPTION_NEBULA_MEDIA_DOWNLOAD);
    ...
    public static void removeItems(
        ...
        for (int i = 0; i < options.size(); i++) {
            ...
            if (o == ChatActivity.OPTION_SAVE_TO_GALLERY || o == ChatActivity.OPTION_SAVE_TO_GALLERY2) {
                remove = noforwardsOrPaidMedia || !NebulaConfig.showSaveToGallery;
            } else if (o == ChatActivity.OPTION_SAVE_TO_DOWNLOADS_OR_MUSIC) {
                remove = noforwardsOrPaidMedia || !NebulaConfig.showSaveToDownloads;
            } else if (o == ChatActivity.OPTION_SHARE) {
                remove = noforwardsOrPaidMedia || !NebulaConfig.showShare;
            } else if (o == ChatActivity.OPTION_COPY) {
                remove = noforwardsOrPaidMedia;
            } else if (o == OPTION_COPY_PHOTO) {
                remove = noforwardsOrPaidMedia || !NebulaConfig.showCopyPhoto;
            } else if (o == OPTION_COPY_PHOTO_AS_STICKER) {
                remove = noforwardsOrPaidMedia || !NebulaConfig.showCopyPhotoAsSticker;
            } else if (o == ChatActivity.OPTION_FORWARD) {
                remove = noforwardsOrPaidMedia || !NebulaConfig.showForward;
            } else if (o == OPTION_FORWARD_WO_AUTHOR) {
                remove = noforwardsOrPaidMedia || !NebulaConfig.showForwardWoAuthorship;
            }
    ...
    public static void showMessageMenuItemsConfigurator(BaseFragment fragment) {
        ...
        menuItems.add(new MenuItemConfig(
                ...
                () -> NebulaConfig.showSaveForNotifications,
        ...
        menuItems.add(new MenuItemConfig(
                ...
                () -> NebulaConfig.showSaveToGallery,
        ...
        menuItems.add(new MenuItemConfig(
                ...
                R.drawable.msg_copy,
                () -> NebulaConfig.showCopyPhotoAsSticker,
        ...
        menuItems.add(new MenuItemConfig(
                ...
                () -> NebulaConfig.showSaveToDownloads,
        ...
        menuItems.add(new MenuItemConfig(
                ...
                () -> NebulaConfig.showClearFromCache,
        ...
        menuItems.add(new MenuItemConfig(
                ...
                R.drawable.msg_forward,
                () -> NebulaConfig.showForwardWoAuthorship,
