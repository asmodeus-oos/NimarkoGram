/**
 * This is the source code of NebulaGram for Android.
 ...
 */
package app.nebulagram.messenger.preferences.tabs;
...
public class MainTabsPreviewCell extends ViewGroup {
    ...
    public void setTabs(
        ...
        this.boundShowSearch = NebulaConfig.showSearchInTabs;
    ...
    public void refresh() {
        ...
        this.boundShowSearch = app.nebulagram.messenger.NebulaConfig.showSearchInTabs;
        if (sourceTabs != null) {
            rebuildFromSource();
        } else {
            rebuildFromFixedLayout();
    ...
    private void rebuildFromFixedLayout() {
        ...
        final boolean titleVisible = NebulaConfig.showMainTabsTitle;
        for (int i = 0; i < tabs.length; i++) {
            GlassTabView tab = tabs[i];
    ...
    private void rebuildFromSource() {
        ...
        for (MainTabsManager.Tab t : src) {
            if (t.getType() == MainTabsManager.TabType.SEARCH && !NebulaConfig.showSearchInTabs) continue;
