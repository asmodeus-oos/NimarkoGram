...
public class StickerSizeCell extends FrameLayout {
    ...
    private final int min = (int) NebulaConfig.STICKER_SIZE_MIN;
    private final int max = (int) NebulaConfig.STICKER_SIZE_MAX;
    ...
    public StickerSizeCell(Context context, BaseFragment fragment) {
        ...
        seekBar.setDelegate(new SeekBarView.SeekBarViewDelegate() {
            ...
            public void onSeekBarDrag(boolean stop, float progress) {
                ...
                NebulaConfig.setStickerSize(value);
            ...
            @Override public CharSequence getContentDescription() {
                return getString(R.string.NM_StickerSize) + ": " + Math.round(NebulaConfig.stickerSize);
            }
        ...
        float progress = (NebulaConfig.stickerSize - min) / (float) (max - min);
        seekBar.setProgress(LocaleController.isRTL ? 1f - progress : progress);
        onValueChanged(Math.round(NebulaConfig.stickerSize), false);
    }
