...
package app.nebulagram.messenger.preferences.helpers;
...
import app.nebulagram.messenger.preferences.cells.StickerSliderCell;

public class NebulaAlertDialogSwitchers {
    ...
    public static void showMessageSize(BaseFragment fragment) {
        ...
        largerVoiceMessagesLayout.setBackground(Theme.AdaptiveRipple.filledRect(
                ...
                16));
        largerVoiceMessagesLayout.setTextAndCheck(getString(R.string.NM_MZ_LargerVoiceMessages), NebulaConfig.largerVoiceMessagesLayout, true);
        largerVoiceMessagesLayout.setOnClickListener(v -> {
            NebulaConfig.toggleLargerVoiceMessagesLayout();
            largerVoiceMessagesLayout.setChecked(NebulaConfig.largerVoiceMessagesLayout);
        });
        ...
        StickerSliderCell mediaSize = new StickerSliderCell(context, resourcesProvider)
                ...
                .setContract(new StickerSliderCell.TGSLContract() {
                    ...
                    public void setValue(int value) {
                        NebulaConfig.setSlider_mediaAmplifier(value);
                    }

                    @Override
                    public int getPreferenceValue() {
                        return NebulaConfig.slider_mediaAmplifier;
                    }
        ...
        StickerSliderCell gifSize = new StickerSliderCell(context, resourcesProvider)
                ...
                .setContract(new StickerSliderCell.TGSLContract() {
                    @Override
                    public void setValue(int value) {
                        NebulaConfig.setSlider_gifsAmplifier(value);
                    }

                    @Override
                    public int getPreferenceValue() {
                        return NebulaConfig.slider_gifsAmplifier;
                    }
    ...
    public static void showRecentEmojisAndStickers(BaseFragment fragment) {
        ...
        StickerSliderCell emojiCount = new StickerSliderCell(context, resourcesProvider)
                ...
                .setContract(new StickerSliderCell.TGSLContract() {
                    @Override
                    public void setValue(int value) {
                        NebulaConfig.setRecentEmojisAmplifier(value);
                    }

                    @Override
                    public int getPreferenceValue() {
                        return NebulaConfig.recentEmojisAmplifier;
                    }
        ...
        StickerSliderCell stickerCount = new StickerSliderCell(context, resourcesProvider)
                ...
                .setContract(new StickerSliderCell.TGSLContract() {
                    @Override
                    public void setValue(int value) {
                        NebulaConfig.setRecentStickersAmplifier(value);
                    }

                    @Override
                    public int getPreferenceValue() {
                        return NebulaConfig.recentStickersAmplifier;
                    }
