...
import app.nebulagram.messenger.banners.NebulaBannerConfig;
import app.nebulagram.messenger.banners.NebulaBannerController;
...
public class BannerPreferencesActivity extends BasePreferencesActivity {
    ...
    public void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        items.add(SettingsHelper.asSwitchCG(ID_LITE,
                ...
                .setChecked(NebulaBannerConfig.liteMode));
        ...
        if ("approved".equals(st)) {
            ...
            items.add(SettingsHelper.asSwitchCG(ID_USE_AVATAR,
                    ...
                    .setChecked(NebulaBannerConfig.useAvatar));
            String lp = NebulaBannerConfig.getLocalBannerPath();
    ...
    public void onClick(UItem item, View view, int position, float x, float y) {
        ...
        switch (item.id) {
            case ID_ENABLED:
                NebulaBannerConfig.toggleEnabled();
                ctrl.setPollingEnabled(NebulaBannerConfig.enabled);
                updateCheckState(view, NebulaBannerConfig.enabled);
                reload();
                break;
            case ID_HIDE_AVATAR: {
            ...
            case ID_USE_AVATAR:
                NebulaBannerConfig.setUseAvatar(!NebulaBannerConfig.useAvatar);
                updateCheckState(view, NebulaBannerConfig.useAvatar);
                reload();
                break;
            case ID_LITE:
                NebulaBannerConfig.setLiteMode(!NebulaBannerConfig.liteMode);
                updateCheckState(view, NebulaBannerConfig.liteMode);
                reload();
                break;
    ...
    private void processPickedFile(Uri uri, boolean global) {
        ...
        try {
            ...
            String ext = NebulaBannerController.detectBannerExtension(tmp);
            if (ext == null) {
                tmp.delete();
