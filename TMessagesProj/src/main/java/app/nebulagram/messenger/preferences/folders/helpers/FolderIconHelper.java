...
package app.nebulagram.messenger.preferences.folders.helpers;
...
public class FolderIconHelper {
    ...
    public static int getPadding() {
        ...
        if (NebulaConfig.tabMode == NebulaConfig.TAB_TYPE_MIX) {
    ...
    public static int getTotalIconWidth() {
        int result = 0;
        if (NebulaConfig.tabMode != NebulaConfig.TAB_TYPE_TEXT) {
