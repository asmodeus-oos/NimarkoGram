...
public final class NebulaUpdateConfig {

    private NebulaUpdateConfig() {}

    private static SharedPreferences prefs() {
        return ApplicationLoader.applicationContext.getSharedPreferences("nebula_update", android.content.Context.MODE_PRIVATE);
    }
