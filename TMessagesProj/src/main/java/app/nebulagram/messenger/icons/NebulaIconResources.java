 ...
 * Ported to Java for NebulaGram.
 */

package app.nebulagram.messenger.icons;
...
import app.nebulagram.messenger.icons.icon_replaces.BaseIconReplace;
import app.nebulagram.messenger.icons.icon_replaces.NoIconReplace;
import app.nebulagram.messenger.icons.icon_replaces.SolarIconReplace;
import app.nebulagram.messenger.icons.icon_replaces.LiquidGlassFullReplace;
import app.nebulagram.messenger.icons.icon_replaces.PlumpyFullReplace;

@SuppressLint("UseCompatLoadingForDrawables")
public class NebulaIconResources extends Resources {
    ...
    private static volatile NebulaIconResources sInstalled;
    ...
    public NebulaIconResources(Resources wrapped) {
        super(wrapped.getAssets(), wrapped.getDisplayMetrics(), wrapped.getConfiguration());
        this.wrapped = wrapped;
        applySelection(NebulaConfig.iconReplacement, 1L);
    ...
    public static android.graphics.Bitmap activeBackArrowBitmap() {
        NebulaIconResources self = sInstalled;
    ...
    public static Drawable getStockDrawable(android.content.Context context, int id) {
        ...
        if (resources instanceof NebulaIconResources) {
            return ((NebulaIconResources) resources).loadRaw(id, 0, theme);
        }
    ...
    public long reloadReplacements(final Runnable onApplied) {
        ...
        synchronized (replacementLock) {
            final int selection = NebulaConfig.iconReplacement;
    ...
    public boolean isReplacementGenerationCurrent(long generation) {
        ...
        return state != null
                ...
                && state.selection == NebulaConfig.iconReplacement;
    }
    ...
    public void prewarmFolderIconsBlocking() {
        ...
        synchronized (folderWarmLock) {
            ...
            for (Integer drawableId : new java.util.HashSet<>(
                    app.nebulagram.messenger.preferences.folders.helpers
