package app.nebulagram.messenger;
...
public final class NebulaConfig {
    public static final String APP_NAME = "NebulaGram";
    ...
    private static final String PREFS_NAME = "nebulaconfig";
    ...
    public static void togglePluginsSafeMode() {
        ...
        try {
            org.telegram.messenger.FileLog.d("nebula: togglePluginsSafeMode -> " + pluginsSafeMode);
        } catch (Throwable ignored) {}
    }
    public static void setPluginsSafeMode(boolean v) {
        ...
        try {
            org.telegram.messenger.FileLog.d("nebula: setPluginsSafeMode = " + v);
        } catch (Throwable ignored) {}
    }
    ...
    public static boolean nebulaMediaAuto = getPreferences().getBoolean("nebulaMediaAuto", true);
    public static void toggleNebulaMediaAuto() {
        nebulaMediaAuto = !nebulaMediaAuto;
        getEditor().putBoolean("nebulaMediaAuto", nebulaMediaAuto).apply();
    }
    public static int nebulaMediaYtFmt = getPreferences().getInt("nebulaMediaYtFmt", 0);
    public static void setNebulaMediaYtFmt(int v) {
        nebulaMediaYtFmt = v;
        getEditor().putInt("nebulaMediaYtFmt", v).apply();
    }
    public static boolean nebulaMediaYtAsk = getPreferences().getBoolean("nebulaMediaYtAsk", true);
    public static void toggleNebulaMediaYtAsk() {
        nebulaMediaYtAsk = !nebulaMediaYtAsk;
        getEditor().putBoolean("nebulaMediaYtAsk", nebulaMediaYtAsk).apply();
    }
    ...
    private static int initCameraType() {
        SharedPreferences prefs = getPreferences();
        boolean defaultCameraX = app.nebulagram.messenger.camera.CameraXUtils.isCameraXSupported();
    ...
    private static void onPrivacyProtectionChanged() {
        try {
            app.nebulagram.messenger.security.NebulaBiometricPrompt.clearVerified();
            org.telegram.messenger.AndroidUtilities.runOnUIThread(
                    org.telegram.ui.LaunchActivity::invalidateNebulaSecureFlag);
        } catch (Throwable ignored) {
        }
    }
    ...
    public static boolean nebulaTextAnim = getPreferences().getBoolean("nebulaTextAnim", true);
    public static void toggleNebulaTextAnim() {
        nebulaTextAnim = !nebulaTextAnim;
        getEditor().putBoolean("nebulaTextAnim", nebulaTextAnim).apply();
        app.nebulagram.messenger.textanim.NebulaTextAnim.applySettings();
    }

    public static boolean nebulaTextAnimAppear = getPreferences().getBoolean("nebulaTextAnimAppear", true);
    public static void toggleNebulaTextAnimAppear() {
        nebulaTextAnimAppear = !nebulaTextAnimAppear;
        getEditor().putBoolean("nebulaTextAnimAppear", nebulaTextAnimAppear).apply();
        app.nebulagram.messenger.textanim.NebulaTextAnim.applySettings();
    }

    public static boolean nebulaTextAnimCursor = getPreferences().getBoolean("nebulaTextAnimCursor", true);
    public static void toggleNebulaTextAnimCursor() {
        nebulaTextAnimCursor = !nebulaTextAnimCursor;
        getEditor().putBoolean("nebulaTextAnimCursor", nebulaTextAnimCursor).apply();
        app.nebulagram.messenger.textanim.NebulaTextAnim.applySettings();
    }

    public static boolean nebulaTextAnimDelete = getPreferences().getBoolean("nebulaTextAnimDelete", true);
    public static void toggleNebulaTextAnimDelete() {
        nebulaTextAnimDelete = !nebulaTextAnimDelete;
        getEditor().putBoolean("nebulaTextAnimDelete", nebulaTextAnimDelete).apply();
        app.nebulagram.messenger.textanim.NebulaTextAnim.applySettings();
    }

    public static boolean nebulaTextAnimSpoiler = getPreferences().getBoolean("nebulaTextAnimSpoiler", false);
    public static void toggleNebulaTextAnimSpoiler() {
        nebulaTextAnimSpoiler = !nebulaTextAnimSpoiler;
        getEditor().putBoolean("nebulaTextAnimSpoiler", nebulaTextAnimSpoiler).apply();
        app.nebulagram.messenger.textanim.NebulaTextAnim.applySettings();
    }
    ...
    public static void setMsgFiltersCollapseAutomatically(boolean v) {
        ...
        app.nebulagram.messenger.chats.filters.MessagesFilterHelper.INSTANCE.clearRevealedMessages();
