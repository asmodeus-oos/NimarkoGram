package app.nebulagram.messenger.infocards;
...
public final class InfoCardRates {
    ...
    private static final String TAG = "NebulaCardRates";
    private static final String RATES_URL = org.telegram.messenger.BuildConfig.NEBULA_INFOCARD_RATES_URL;
