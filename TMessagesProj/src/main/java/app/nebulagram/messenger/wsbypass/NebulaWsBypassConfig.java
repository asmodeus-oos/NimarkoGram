...
public final class NebulaWsBypassConfig {

    public static final String PREFS_NAME = "nebula_wsbypass";
    ...
    public static SharedPreferences prefs() {
        ...
        if (p == null) {
            synchronized (NebulaWsBypassConfig.class) {
                p = cached;
                if (p == null) {
    ...
    public static void setEnabled(boolean v) {
        app.nebulagram.messenger.wsbypass.voip.VoipBypassConfig.mutateRelayState(() -> {
