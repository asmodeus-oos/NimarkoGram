package app.nebulagram.messenger.security;
...
public class NebulaBiometricPrompt {

    private static final String TAG = "NebulaBiometricPrompt";
    ...
    public static void callBiometricPrompt(Activity activity, NebulaBiometricListener listener) {
        callBiometricPrompt(activity, UserConfig.selectedAccount, listener);
    }

    public static void callBiometricPrompt(Activity activity, int account, NebulaBiometricListener listener) {
        callBiometricPrompt(activity, account,
                app.nebulagram.messenger.NebulaConfig.allowSystemPasscode, listener);
    }

    public static void callBiometricPrompt(Activity activity, int account,
                                           boolean allowSystem, NebulaBiometricListener listener) {
    ...
    public static void prompt(Activity activity, int account, Runnable successCallback, Runnable failCallback) {
        prompt(activity, account, app.nebulagram.messenger.NebulaConfig.allowSystemPasscode,
    ...
    public static void prompt(Activity activity, int account, boolean allowSystem,
        ...
        callBiometricPrompt(activity, account, allowSystem, new NebulaBiometricListener() {
            @Override
    ...
    public interface NebulaBiometricListener {
    ...
    public static boolean canAuthenticateConfigured() {
        return canAuthenticate(app.nebulagram.messenger.NebulaConfig.allowSystemPasscode);
    }
    ...
    private static void startPrompt(FragmentActivity activity, int account, boolean allowSystem,
                                    NebulaBiometricListener callback) {
    ...
    public static void fixFingerprint(Activity activity, NebulaBiometricListener callback) {
        fixFingerprint(activity, UserConfig.selectedAccount, callback);
    }

    public static void fixFingerprint(Activity activity, int account, NebulaBiometricListener callback) {
        ...
        startPrompt((FragmentActivity) activity, account,
                app.nebulagram.messenger.NebulaConfig.allowSystemPasscode,
                new NebulaBiometricListener() {
            @Override
            public void onSuccess(BiometricPrompt.AuthenticationResult result) {
    ...
    public static boolean isRecentlyVerified(int account, long userId, long chatId, int encId) {
        int ttlSec = app.nebulagram.messenger.NebulaConfig.lockedChatsBiometricTtlSec;
        long effectiveTtlMs;
        if (ttlSec == 0) {
    ...
    public static void onAppBackgrounded() {
        synchronized (recentlyVerified) {
            if (app.nebulagram.messenger.NebulaConfig.lockedChatsBiometricTtlSec == 0) {
                recentlyVerified.clear();
            }
        }
    }
