...
import app.nebulagram.messenger.NebulaCrashHandler;
...
public final class NativeCrashHandler {
    ...
    private static final String DIAGNOSTICS_PREFS = "nebula_crash_diagnostics";
        ...
        try {
            Thread worker = new Thread(() -> {
                try {
                    ...
                    FileLog.e("nebula: previous-exit diagnostics failed", t);
                }
            }, "ng-exit-diagnostics");
    ...
    public static void checkAndHandleNativeCrash() {
        ...
        if (legacyFlagSeen && !file.delete()) {
            FileLog.w("nebula: unable to remove stale native crash flag");
        }
        ...
        FileLog.e("nebula: captured previous process exit: "
    ...
    private static void writeExitReport(ApplicationExitInfo info, boolean legacyFlagSeen) {
        try {
            File dir = NebulaCrashHandler.getLogDir();
            if (dir == null) return;
            ...
            try (PrintWriter writer = new PrintWriter(
                ...
                writer.println("=== NebulaGram previous process exit ===");
            ...
            try {
                android.util.Log.e("nebula-crash", "failed to write previous-exit report", t);
            } catch (Throwable ignored) {
            }
        }
    }
