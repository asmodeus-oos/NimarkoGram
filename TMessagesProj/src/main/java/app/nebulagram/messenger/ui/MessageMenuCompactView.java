...
public class MessageMenuCompactView extends LinearLayout {
    ...
    public static boolean allowCompactStyle() {
        return NebulaConfig.msgMenuItemsCompactView;
    }

    public static boolean allowCompactStyle(long dialogId) {
        return NebulaConfig.isCompactForChat(dialogId);
    }
    ...
    public static boolean install(
        ...
        addFirst(
                ...
                NebulaMessageMenuInjector.OPTION_COPY_PHOTO,
                NebulaMessageMenuInjector.OPTION_COPY_PHOTO_AS_STICKER,
        ...
        addFirst(
                ...
                NebulaMessageMenuInjector.OPTION_FORWARD_WO_AUTHOR,
