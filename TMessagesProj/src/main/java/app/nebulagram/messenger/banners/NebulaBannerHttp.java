...
public final class NebulaBannerHttp {

    public static final String API = org.telegram.messenger.BuildConfig.NEBULA_BANNER_API_URL;
    public static final String PLACEHOLDER_URL = org.telegram.messenger.BuildConfig.NEBULA_BANNER_PLACEHOLDER_URL;
    ...
    public static SubmitResult submit(File file, String ext, long userId, long size, String token) {
        ...
        try {
            ...
            FileLog.e("nebula-banner: submit failed", t);
            out.httpCode = -1;
            return out;
        }
    }
