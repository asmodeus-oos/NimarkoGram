package app.nebulagram.messenger.camera;
...
import app.nebulagram.messenger.NebulaCameraLog;

public class NebulaCameraXController implements CameraXProviderCoordinator.Owner {
    ...
    @Nullable private NebulaCameraXController concurrentPeer;
    ...
    public NebulaCameraXController(CameraLifecycle lifecycle, MeteringPointFactory factory, Preview.SurfaceProvider surfaceProvider) {
        this(lifecycle, factory, surfaceProvider, null);
    }

    public NebulaCameraXController(CameraLifecycle lifecycle, MeteringPointFactory factory,
    ...
    public void setFrontFace(boolean isFrontFace) {
        ...
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController switch requested fromFront=" + isFrontface
                + " toFront=" + isFrontFace + " provider=" + (provider != null));
        isFrontface = isFrontFace;
        if (provider != null && !bindUseCases()) {
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController switch bind FAILED front=" + isFrontface);
    ...
    public void initCamera(Context context, boolean isInitialFrontface, @Nullable Runnable onReady,
        ...
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.dumpCameraInventory(context, "CameraX controller init");
        ...
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController init generation=" + requestGeneration
        ...
        try {
            ...
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController provider future=" + future);
            future.addListener(() -> {
                synchronized (initializationLock) {
                    ...
                    try {
                        ...
                        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController provider ready generation="
                        ...
                        initiated = false;
                        FileLog.e(t);
                        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController provider/init FAILED generation="
                                + requestGeneration, t);
                        reportFailure(t);
                    }
                }
            ...
            synchronized (initializationLock) {
                ...
                initiated = false;
                FileLog.e(t);
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController init threw generation="
                        + requestGeneration, t);
                reportFailure(t);
            }
        }
    ...
    public void closeCamera() {
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController close front=" + isFrontface
    ...
    public boolean bindUseCases() {
        if (closed || provider == null || surfaceProvider == null) {
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController bind skipped closed=" + closed
                    + " provider=" + (provider != null)
                    + " surfaceProvider=" + (surfaceProvider != null));
            return false;
        }
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController bind begin front=" + isFrontface
        ...
        try {
            ...
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController bind end result=" + result
                    + " camera=" + cameraId(boundCamera)
                    + " fps=" + appliedTargetFpsRange);
            return result;
        } catch (Throwable error) {
            FileLog.e("CameraX ownership bind failed", error);
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController ownership bind FAILED", error);
    ...
    private boolean bindUseCasesOwned() {
        ...
        try {
            ...
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController optimized bind FAILED", t);
        }
        ...
        if (requestedFpsWasApplied) {
            try {
                ...
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController no-FPS retry FAILED", retryError);
            }
        }
        ...
        try {
            ...
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController safe fallback FAILED", retryError);
        }
    ...
    private boolean bindPreparedUseCases() {
        ...
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController bindPrepared selector="
        ...
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController bindPrepared result=" + initiated
                + " camera=" + cameraId(boundCamera));
        return initiated;
    }
    ...
    private boolean prepareUseCases(boolean rebuild, boolean concurrentPreview,
        ...
        try {
            ...
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController prepare rebuild=" + rebuild
            ...
            boolean configuredStartFromUltraWide = !isFrontface
                    && (useConfiguredUltraWide && NebulaConfig.startFromUltraWideCam
            ...
            if (configuredStartFromUltraWide && concurrentPreview
                    && !startFromUltraWide) {
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log(
            ...
            if (startFromUltraWide && previewExtender != null
                ...
                try {
                    ...
                    if (initialRatio < 0.999f) {
                        ...
                        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController initial wide control ratio="
            ...
            if (startFromUltraWide && previewExtender != null
                ...
                if (expectedInitialPhysicalCameraId != null) {
                    ...
                    if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController waiting for physical wide="
                            + expectedInitialPhysicalCameraId);
                }
            }
            ...
            FileLog.e(t);
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController prepare FAILED front=" + isFrontface
    ...
    private static void installConcurrentCamera2Diagnostics(
        ...
        extender.setDeviceStateCallback(new CameraDevice.StateCallback() {
            ...
            public void onOpened(@NonNull CameraDevice camera) {
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXDevice OPENED id=" + camera.getId()
                        + " " + label);
            }

            @Override
            public void onDisconnected(@NonNull CameraDevice camera) {
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXDevice DISCONNECTED id=" + camera.getId()
                        + " " + label);
            }

            @Override
            public void onError(@NonNull CameraDevice camera, int error) {
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXDevice ERROR id=" + camera.getId()
                        + " code=" + error + " " + label);
            }

            @Override
            public void onClosed(@NonNull CameraDevice camera) {
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXDevice CLOSED id=" + camera.getId()
                        + " " + label);
            }
        });
        extender.setSessionStateCallback(new CameraCaptureSession.StateCallback() {
            ...
            public void onConfigured(@NonNull CameraCaptureSession session) {
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSession CONFIGURED id="
                        + session.getDevice().getId() + " " + label);
            }

            @Override
            public void onConfigureFailed(@NonNull CameraCaptureSession session) {
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSession CONFIGURE_FAILED id="
                        + session.getDevice().getId() + " " + label);
            }

            @Override
            public void onActive(@NonNull CameraCaptureSession session) {
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSession ACTIVE id="
                        + session.getDevice().getId() + " " + label);
            }

            @Override
            public void onReady(@NonNull CameraCaptureSession session) {
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSession READY id="
                        + session.getDevice().getId() + " " + label);
            }

            @Override
            public void onClosed(@NonNull CameraCaptureSession session) {
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSession CLOSED id="
                        + session.getDevice().getId() + " " + label);
            }
        });
    }
    ...
    private void detachConcurrentPeer() {
        NebulaCameraXController peer = concurrentPeer;
        concurrentPeer = null;
    ...
    public boolean isConcurrentWith(@Nullable NebulaCameraXController other) {
    ...
    public boolean bindConcurrentWith(@Nullable NebulaCameraXController other) {
    ...
    public boolean bindConcurrentWith(@Nullable NebulaCameraXController other,
        ...
        final NebulaCameraXController backController = isFrontface ? other : this;
        final NebulaCameraXController frontController = isFrontface ? this : other;
        if (backController.isFrontface || !frontController.isFrontface) {
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController concurrent rejected: pair is not front/back");
            return false;
        }
        ...
        if (selectors == null) {
            ...
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController concurrent unavailable backFront="
                    + backController.isFrontface + " frontFront=" + frontController.isFrontface);
            return false;
        }

        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController concurrent begin compatibility="
        ...
        try {
            ...
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController concurrent configs commonLifecycle=true"
            ...
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController concurrent returned order=["
            ...
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController concurrent providerMode="
                    + provider.isConcurrentCameraModeOn());
            
            backController.lifecycle.start();
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController concurrent lifecycle activated state="
                    + backController.lifecycle.getLifecycle().getCurrentState());
            
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController concurrent bound back="
            ...
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController concurrent FAILED compatibility="
    ...
    private void notifyReady() {
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController notifyReady front=" + isFrontface
                + " initiated=" + initiated + " camera=" + cameraId(boundCamera));
    ...
    private void reportFailure(Throwable throwable) {
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController reportFailure front=" + isFrontface, throwable);
    ...
    public int setExposureCompensationIndex(int index) {
        ...
        try {
            ...
            trackControlFuture(result, camera, generation,
                    ...
                    () -> NebulaConfig.setCameraExposureIndex(configured));
            return clamped;
        } catch (Throwable t) {
            FileLog.e(t);
    ...
    public boolean takePicture(final File file, @Nullable Runnable onTake,
        ...
        if (capture == null || file == null) {
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController photo rejected capture=" + (capture != null)
                    + " file=" + file);
            return false;
        }
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController photo start file=" + file.getAbsolutePath()
        ...
        try {
            ...
            capture.takePicture(options,
                    ...
                    new ImageCapture.OnImageSavedCallback() {
                        ...
                        public void onImageSaved(@NonNull ImageCapture.OutputFileResults outputFileResults) {
                            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController photo saved file="
                        ...
                        public void onError(@NonNull ImageCaptureException exception) {
                            FileLog.e(exception);
                            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController photo FAILED file="
            ...
            FileLog.e(t);
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController photo dispatch FAILED file=" + file, t);
    ...
    public void attachBoundCamera(@Nullable Camera camera) {
        ...
        baseZoomRatio = 1f;
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController attach camera=" + cameraId(camera)
        ...
        try {
            ...
            boundCameraStateObserver = state -> {
                ...
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController state camera=" + cameraId(camera)
                        + " type=" + state.getType()
            ...
            FileLog.e(t);
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController camera-state observer FAILED", t);
        }
    }
    ...
    private synchronized boolean prepareInitialZoom(Camera camera, int generation) {
        ...
        try {
            ...
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController initial zoom camera=" + cameraId(camera)
                    + " front=" + isFrontface
                    + " concurrent=" + (concurrentPeer != null)
                    + " configuredWide=" + NebulaConfig.startFromUltraWideCam
                    + " base=" + baseZoomRatio
        ...
        try {
            ...
            if (exposure != null && exposure.isExposureCompensationSupported()) {
                ...
                int index = CameraXUtils.configuredExposureToIndex(
                        NebulaConfig.cameraExposureIndex, lower, upper);
        ...
        Runnable task = new Runnable() {
            ...
            public void run() {
                ...
                ConcurrentCameraResourceException persistentError =
                        ...
                        cause);
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXController concurrent camera-in-use persisted camera="
