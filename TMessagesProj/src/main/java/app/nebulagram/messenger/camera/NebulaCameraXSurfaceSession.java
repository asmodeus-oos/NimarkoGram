...
public final class NebulaCameraXSurfaceSession {
    ...
    private final NebulaCameraXController controller;
    ...
    public NebulaCameraXSurfaceSession(Context context, SurfaceTexture surfaceTexture,
    ...
    public NebulaCameraXSurfaceSession(Context context, SurfaceTexture surfaceTexture,
        ...
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface create renderId=" + renderId
        ...
        NebulaCameraXController.CameraLifecycle lifecycle =
                new NebulaCameraXController.CameraLifecycle();
        Preview.SurfaceProvider provider = this::provideSurface;
        controller = new NebulaCameraXController(
                lifecycle,
    ...
    private void provideSurface(SurfaceRequest request) {
        if (closed) {
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface request rejected: closed renderId=" + renderId);
        ...
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface request renderId=" + renderId
        ...
        try {
            request.setTransformationInfoListener(ContextCompat.getMainExecutor(context), info -> {
                ...
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface transform renderId=" + renderId
            ...
            request.provideSurface(suppliedSurface, ContextCompat.getMainExecutor(context), result -> {
                ...
                if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface released renderId=" + renderId
            ...
            FileLog.e(t);
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface provide FAILED renderId=" + renderId
    ...
    private void notifyReady() {
        ...
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface ready renderId=" + renderId
    ...
    private void notifyFailure(Throwable error) {
        if (closed || callback == null) return;
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface failure renderId=" + renderId, error);
        try {
    ...
    public void releaseSurfaceForRebind(Runnable onReleased) {
        ...
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface releaseForRebind renderId=" + renderId
    ...
    public NebulaCameraXController getController() {
        return controller;
    }
    ...
    public void switchCamera(boolean frontFacing) {
        if (!closed) {
            if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface switch renderId=" + renderId
    ...
    public boolean bindConcurrentWith(@Nullable NebulaCameraXSurfaceSession other) {
        return bindConcurrentWith(other, false);
    }

    public boolean bindConcurrentWith(@Nullable NebulaCameraXSurfaceSession other,
                                      boolean compatibilityProfile) {
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface concurrent request first=" + renderId
        ...
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface concurrent result=" + result
                + " first=" + renderId + " second="
                + (other == null ? "null" : other.renderId));
        return result;
    }

    public boolean isConcurrentWith(@Nullable NebulaCameraXSurfaceSession other) {
    ...
    public void close(@Nullable Runnable onClosed) {
        if (NebulaCameraLog.DEBUG) NebulaCameraLog.log("CXSurface close renderId=" + renderId
