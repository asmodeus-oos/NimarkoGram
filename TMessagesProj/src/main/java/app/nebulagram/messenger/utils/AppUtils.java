...
public final class AppUtils {
    ...
    public static void log(String message) { FileLog.d("nebula-plugin: " + message); }
    public static void log(Throwable t) { FileLog.e(t); }
    public static void log(String message, Throwable t) { FileLog.e("nebula-plugin: " + message, t); }
