...
package app.nebulagram.messenger.utils.icons
...
import app.nebulagram.messenger.utils.icons.icon_replaces.BaseIconReplace
import app.nebulagram.messenger.utils.icons.icon_replaces.NoIconReplace
import app.nebulagram.messenger.utils.icons.icon_replaces.SolarIconReplace
...
class NGUIResources(private val wrapped: Resources) : Resources(wrapped.assets, wrapped.displayMetrics, wrapped.configuration) {
    ...
    private fun pickReplacement(): BaseIconReplace {
        return if (NebulaConfig.iconReplacement == NebulaConfig.ICON_REPLACE_SOLAR) {
            SolarIconReplace()
        } else {
            NoIconReplace()
        }
