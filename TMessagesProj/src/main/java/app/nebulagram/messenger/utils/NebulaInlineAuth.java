...
public final class NebulaInlineAuth {

    public static final String GIVE_UP = "__nebula_inline_auth_give_up__";
    ...
    private static void sendInlineVerification(int account, String botUsername, String code,
        ...
        try {
            ...
            FileLog.e("nebula-inline-auth: sendInlineVerification failed", t);
        }
    }
