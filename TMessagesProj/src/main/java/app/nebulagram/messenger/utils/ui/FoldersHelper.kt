...
object FoldersHelper {
    ...
    fun getFolderColor(folderId: Int, defaultColor: Int): Int =
        NebulaFoldersHelper.getFolderColor(folderId, defaultColor)

    fun setFolderColor(folderId: Int, color: Int) =
        NebulaFoldersHelper.setFolderColor(folderId, color)

    fun getFolderBadgeMode(folderId: Int): Int =
        NebulaFoldersHelper.getFolderBadgeMode(folderId)

    fun setFolderBadgeMode(folderId: Int, mode: Int) =
        NebulaFoldersHelper.setFolderBadgeMode(folderId, mode)

    fun nextFolderId(accountNum: Int, currentId: Int, direction: Int): Int =
        NebulaFoldersHelper.nextFolderId(accountNum, currentId, direction)

    fun shouldShowDot(folderId: Int, rawCount: Int): Boolean =
        NebulaFoldersHelper.shouldShowDot(folderId, rawCount)
}
