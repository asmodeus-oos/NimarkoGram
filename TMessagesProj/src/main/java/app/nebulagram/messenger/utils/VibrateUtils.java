...
public final class VibrateUtils {
    ...
    public static void vibrateForChatMode(int mode) {
        switch (mode) {
            case NebulaConfig.VIBRATE_CLICK:
                makeClickVibration();
                break;
            case NebulaConfig.VIBRATE_WAVE:
                makeWaveVibration();
                break;
            case NebulaConfig.VIBRATE_KEYBOARD:
                makeClickVibration();
                break;
            case NebulaConfig.VIBRATE_LONG:
                vibrate();
                break;
            case NebulaConfig.VIBRATE_DISABLE:
            default:
                break;
        }
    }
